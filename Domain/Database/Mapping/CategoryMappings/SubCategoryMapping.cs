    ...
    public class SubCategoryMapping : IEntityTypeConfiguration<SubCategory>
    {
        ...
        private List<SubCategory> _categories()
        {
            return new List<SubCategory>
            {
                ...
                new SubCategory { Id = 4, Name = "Spor", CreateBy = "Sistem", Flag = Guid.NewGuid().ToString(), CreateDate = DateTime.Now.ToString(), IsDeleted = false, CategoryId = 4 },
                new SubCategory { Id = 5, Name = "Giyim", CreateBy = "Sistem", Flag = Guid.NewGuid().ToString(), CreateDate = DateTime.Now.ToString(), IsDeleted = false, CategoryId = 5 },
                new SubCategory { Id = 6, Name = "Outdoor", CreateBy = "Sistem", Flag = Guid.NewGuid().ToString(), CreateDate = DateTime.Now.ToString(), IsDeleted = false, CategoryId = 6 }
            };
        }
